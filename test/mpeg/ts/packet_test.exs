defmodule MPEG.TS.PacketTest do
  ...
  describe "MPEG TS Packet marshaler" do
    ...
    test "Marshal a packet with payload and adaptation" do
      ...
      # PCR encoding: 1000 ticks @ 90kHz = 11,111,111 ns = 300,000 ticks @ 27MHz
      # base = 1000, extension = 0 -> bytes: 0x00, 0x00, 0x01, 0xF4, 0x7E, 0x00
      expected_payload =
        <<0x47, 0x41, 0x00, 0x3A, 0x07, 0x50, 0x00, 0x00, 0x01, 0xF4, 0x7E, 0x00,
          payload::binary>>
